...
#########################################################
out, kld1 = bayes_dense(x, 100, name='bayes_dense1', activation='relu')
out, kld2 = bayes_dense(out, 100, name='bayes_dense2', activation='relu')
out, kld3 = bayes_dense(out, 2, name='bayes_dense3')
#########################################################
