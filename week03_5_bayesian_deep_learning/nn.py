...
# Dense(1, 100) - ReLU
# Dense(100, 100) - ReLU
# Dense(100, 2) --> output is mu and sigma
##########################################################
out = dense(x, 100, name='dense1', activation='relu')
out = dense(out, 100, name='dense2', activation='relu')
out = dense(out, 2, name='dense3')
##########################################################
mu, sigma = tf.split(out, 2, axis=-1)
sigma = tf.nn.softplus(sigma)  # softplus makes any number to positive;  log(1+exp(x))
